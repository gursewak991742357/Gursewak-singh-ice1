 ...
 *  Modified by DevkumarPatel Student_id: 991721507
 * @author srinivsi
 */
public class CardTrick {
    ...
    public static void main(String[] args) {
        ...
        Card hand = new Card();
        hand.setValue(userValue);
        hand.setSuit(Card.SUITS[userSuit]);
        
        // Search magicHand for the user's card
        for (Card card : magicHand) {
            if (card.getValue() == hand.getValue() && card.getSuit().equals(hand.getSuit())) {
                System.out.println("Congratulations card found");
                break;
            }
            else{
